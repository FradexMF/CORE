...
class AllenIntervalAlgebraOverlap;     // :o
...
class FormulaVisitor {
 public:
  ...
  virtual void visit(AllenIntervalAlgebraOverlap&) {throw std::logic_error("visit AllenIntervalAlgebraOverlap not implemented.");}
